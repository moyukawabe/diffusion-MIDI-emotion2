...
if __name__ == '__main__':
    ...
    parser.add_argument('--nproc_per_node', type=int, default=2, help='') # 複数GPU05/06
    args = parser.parse_args()

    folder_name = "diffusion_models_finetune_CFG/"
