...
def EMOPIA_threshold():
    feature_table = np.load(r"../jSymbolic_lib/datasets/emopia/data\feature_table.npy")
    ...
    for bucket_num in [3, 5, 8, 12, 16]:
        ...
        np.save(f"../jSymbolic_lib/datasets/emopia/data/threshold_{bucket_num}.npy", thresholds)
